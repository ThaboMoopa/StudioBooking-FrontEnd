...
function findById($id)
{
    ...
    curl_setopt_array($curl, array(
        CURLOPT_PORT => "8091",
        CURLOPT_URL => "http://localhost:8091/organisation/addOrganisation?organisationName=$name&contactDetails=$contact&contactPerson=$additionalContact&webAddress=$webAddress",
...
function addOrganisation($name,$webAddress,$contact,$additionalContact)
{
    //echo "im in";
    $curl = curl_init();
    curl_setopt_array($curl, array(
...
function findByName($search)
{
    ...
    curl_setopt_array($curl, array(
        CURLOPT_PORT => "8091",
        CURLOPT_URL => "http://localhost:8091/organisation/findByName?name=$search",
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => "",
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 30,
