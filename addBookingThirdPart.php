                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <select class="form-control" id="txtLength">
                            ...
                            <option value = "18">Whole Day</option>
                        </select>
...
<!--                    </div>-->
                ...
                <div class="row">
                    <div class="col-sm-3">
                        ...
                        <small id="errorMessage" class="form-text text-muted">Type in the dates for RCS files. (Example: TBC or tbc or days(01 07 14))</small>
...
<!--                    </div>-->
                ...
                <div class="form-group">
                    <div class="col-sm-7">
                        <button id="book" name="book" class="btn btn-outline-success" value="Make a booking" >Continue </button>
                    </div>
